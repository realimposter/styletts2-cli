...
from models import *
from smoothie.styletts2_cli.utils import *
...
config = yaml.safe_load(open("/smoothie/styletts2-cli/Models/LibriTTS/config.yml"))
...
def init(PTH_PATH):
    global params_whole, model, params
    params_whole = torch.load(PTH_PATH, map_location="cpu")
